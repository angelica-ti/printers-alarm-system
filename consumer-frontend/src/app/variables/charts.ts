...
export const chartExample1 = {
  ...
  data: {
    labels: ['driver', 'toner', 'papel', 'cabos', 'rolamento', 'fusor'],
    datasets: [{
      label: 'Categoria',
...
export const chartExample2 = {
  ...
  data: {
    labels: ["EPSON", "HP", "BROTHER", "ELGIN", "FUGIFILM", "CANON", "LEXMARK", "ZEBRA", "ARGOX", "XEROX"],
    datasets: [
      {
        label: "Sales",
        data: [25, 20, 30, 22, 17, 29, 10, 10, 10, 10],
        maxBarThickness: 10
      }
    ]
  }
